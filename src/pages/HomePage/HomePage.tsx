    ...
    <section>
      <div>
        <p>
          ...
          every character, planet and event represents a unique element of this
          epic saga. My project aims to develop the richness and diversity of
          this galaxy by providing information about the characters, planets,
          ships and other elements of this fantasy world. I hope Star Wars fans
          will learn some interesting facts here and enjoy being immersed in
          this exciting space epic. <b>"May the Force be with you!"</b>
        </p>
      </div>
      ...
      <div>
        ...
        <div id="console" className={styles.console}>
          ...
          <div className={styles["console-content"]}>
            ...
            "dependencies": {"{"}
            <br />
            "@reduxjs/toolkit": "^2.1.0", "path": "^0.12.7", "react": "^18.2.0",
            "react-content-loader": "^6.2.1", "react-dom": "^18.2.0",
            "react-helmet-async": "^2.0.4", "react-redux": "^9.1.0",
